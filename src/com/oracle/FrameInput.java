...
public class FrameInput extends javax.swing.JFrame {
    ...
    private Integer indexPass;

    protected Integer getIndexPass() {
        return indexPass;
    }

    protected void setIndexPass(Integer indexPass) {
        this.indexPass = indexPass; // receive index
        System.out.println("me llego ---> " + indexPass);
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Ingrese cantidad");
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        ...
        FrameMoneda frameMoneda = new FrameMoneda();//create instance od frameInput
        frameMoneda.setVisible(true); //open frameInput
        
        frameMoneda.setCantidad(jTextField1.getText());
    ...
    private boolean textFieldInit() {//method to validate if textField has placeHolder (init text)
        if (jTextField1.getText().compareTo("Ingrese cantidad") == 0) {
            return false;
        }
        return true;
    }
